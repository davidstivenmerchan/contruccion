...
<head>
    ...
    <link rel="stylesheet" href="css/elegir_asignacion_informe.css">
...
<div class="titulo">
    ...
    <h1>INFORMES DE ASIGNACION DE COMPUTADORES</h1>
</div>
    <div class="padre">
        <div class="hijo1">
           <a href="../../reportes/asignacion.php"><div class="hijo11"><p>MES ACTUAL</p></div></a> 
        </div>
        <div class="hijo2">
            ...
            <i class="far fa-times-circle" onclick="desaparecer();"></i>
                <form action="../../reportes/asignacion_especifica.php" method="POST">
